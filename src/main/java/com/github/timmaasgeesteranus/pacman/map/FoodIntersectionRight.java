...
public class FoodIntersectionRight extends DynamicCompositeEntity
{
    public FoodIntersectionRight(Coordinate2D initialLocation, Size size) {
    ...
    protected void setupEntities() {
        ...
        var foodHitBox = new FoodHitBox(new Coordinate2D(0, 0), "right");
